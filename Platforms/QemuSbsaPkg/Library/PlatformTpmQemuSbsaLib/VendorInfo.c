...
#define FIRMWARE_HIGH  (0x20260416)
#define FIRMWARE_LOW   (0x00200000)
#define MAX_SVN      255
 ...
 */
STATIC CONST UINT32  CurrentHash = 0x00120000;
STATIC CONST UINT16  CurrentSvn  = 0x10;
